...
<head>
    ...
    <link href="payment_confirmation.css" rel="stylesheet" type="text/css">
    <title>Payment Confirmation - FlyAway</title>
</head>
<body>
     <!-- NAVBAR SECTION -->
     <nav>
    ...
    <main>
    <div>
        <p>THANKS FOR BOOKING A FLIGHT! YOUR PAYMENT HAS BEEN SUCCESSFUL!<p>
		<p>CONTINUE BOOKING...</p>
		<button><a href="./index.jsp">Continue</a></button>
    </div>    
    </main>
